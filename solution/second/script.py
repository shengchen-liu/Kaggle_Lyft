...
def eval_multi_threshold():
    ...
    ckpt_name = "/home/shengchen/Kaggle/second.pytorch/pretrained_models_v1.5/car_fhd/voxelnet-74280.tckpt" # don't forget to change this.
...
def eval():
    config_path = "./configs/car.fhd.config"
    model_dir = "/home/shengchen/Kaggle/second.pytorch/pretrained_models_v1.5/car_onestage"
    ckpt_name = "/home/shengchen/Kaggle/second.pytorch/pretrained_models_v1.5/car_onestage/voxelnet-27855.tckpt"  # don't forget to change this.
    assert "/path/to/your" not in ckpt_name
    config = pipeline_pb2.TrainEvalPipelineConfig()
    with open(config_path, "r") as f:
        proto_str = f.read()
